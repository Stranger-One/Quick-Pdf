...
export default function DemoSection(){
    return <section className="relative">
      ...
      <div className="flex flex-col items-center text-center space-y-4">
        <div className="inline-flex items-center justify-center p-2 rounded-2xl border-gray-500/20 mb-4">
        <Pizza className="w-6 h-6 text-rose-500"></Pizza>
        </div>
        <div className="text-center mb-16">
            <h3 className="font-bold text-3xl max-w-2xl mx-auto px-4 sm:px-6">Watch how Quick-PDF transforms<span className="bg-linear-to-r from-rose-500 to-rose-700 bg-clip-text text-transparent"> This Next.js Course PDF</span> into an easy-to-read summary!</h3>
        </div>
