...
const steps:Step[] = [
    ...
    },
    {
       icon : <BrainCircuit size={64} strokeWidth={1.5}></BrainCircuit>,
        label: "AI Analysis",
        description:'Over advanced Ai Processes and analyzes your document instantly'
    },
     {
      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative">
            ...
            {steps.map((step,idx) => (
                ...
                {idx < steps.length -1 &&(<div className="hidden md:block absolute top-1/2 -right-4 transform -translate-1/2 z-10">
...
function StepItem({icon,label,description}:Step){
    return <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border-white/10 hover:border-rose-500/5 transition-colors group w-full">
